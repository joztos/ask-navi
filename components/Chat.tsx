...
export const initialMessages: Message[] = [
  {
    who: 'bot',
    message: 'Hola! Soy tu asistente de información contable y financiera, preguntame!',
  },
]
