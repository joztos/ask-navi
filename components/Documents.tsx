...
export default function Documents({ baseUrl }: { baseUrl: string }) {
  ...
  return (
    ...
    <div className="flex flex-row content-center pb-4">
      ...
      <div>Las respuestas son generadas por OpenAI GPT utilizando fuentes de estos documentos: </div>
      </div>
    <ListGroup>
...
👋 Contactanos por&nbsp;<a href="https://steamship.com/discord" className="font-semibold text-gray-900 underline dark:text-white decoration-sky-500">Whatsapp</a>&nbsp;si te interesa indexar mas documentos
</ListGroup.Item>
